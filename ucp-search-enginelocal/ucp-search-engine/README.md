...
### Prerequisites
- [Docker Desktop](https://www.docker.com/products/docker-desktop) (for server + Elasticsearch)
- [Node.js 20+](https://nodejs.org/) (for server development)
...
This will:
1. Start Elasticsearch, PostgreSQL, and Redis in Docker
2. Install server dependencies
3. Start the API server
4. Seed 6 demo financial service entities
5. Print all local URLs
...
**4. Open Demo:**
Open `demo.html` in your browser (double-click or use Live Server).
